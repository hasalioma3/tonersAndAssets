...
class Amodel(models.Model):
    ...
    make = models.ForeignKey(Make, related_name='Model',null=True, blank=True,on_delete=models.CASCADE)
    def __str__(self):
        return self.name
...
class Asset(models.Model):
    make = models.ForeignKey(Make, on_delete=models.CASCADE, null=True, blank=True)
    amodel = models.ForeignKey(Amodel, on_delete=models.CASCADE, null=True, blank=True, related_name='model')
...
class Delivery(models.Model):
    ...
    toLocation= models.ForeignKey(Location, on_delete=models.CASCADE, null=True, blank=True, related_name='ToLocation')
